        ...
        <div class="container_right">
            <div class="driver-form">
                <div class="driver-form-text">
                    <h2> Add  Truck </h2>
                    <p style="color: green; margin-top: 6px;"><?php echo $truck_success;?></p>
                </div>
                ...
                <form action="" method="post">
                    <div class="form-left">
                        <div class="input-left">
                            ...
                            <p style="color: red"><?php echo $truck_message; ?></p>
                        </div>
                    ...
                    <div class="form-right">
                        ...
                        <input type="submit" value="Add Truck" class="submit" name="truck">
                    </div>
                </form>
            </div>
        </div>
