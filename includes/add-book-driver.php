<?php
    ...
    if(isset($_POST["book"])){
        ...
        if(!empty($name) || !empty($truck) || !empty($mobile) || !empty($date)){
            ...
            $sql = mysqli_query($conn, "INSERT INTO booking (name, truck, phone, date, driver_id, client_id, notifi, accepted, delivered) VALUES('$name', '$truck', '$mobile', '$date', '$driver_id', '$driver_id', 'true', 'No', 'No')");
