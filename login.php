    ...
    if(isset($_POST["login"])){
        ...
        if(!empty($email)){
            ...
            if(!empty($password)){
                ...
                $sql = mysqli_query($conn, "SELECT * from clients where email = '$email' && password = '$password'");
...
<head>
    ...
    <title> JK Transporters Login </title>
...
<body class="signup">
 ...
 <br>
         <p> Don't have an account? <a href="./signup.php" style="color: #800000; text-decoration: none;"> Sign Up </a> </p>
     </div>
