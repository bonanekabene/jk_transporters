                ...
                <div class="driver-right margin">
                    <table class="table" style="width: 100%;">
                        ...
                        <tbody class="overflow" style="color: #000">
                            <?php
                                $d_sql = mysqli_query($conn, "SELECT * from booking where driver_id = '$driver_id'");
                               ...
                               while($booking_result = mysqli_fetch_assoc($d_sql)){
                                   ...
                                   echo"
                                   <tr class='tr' style='background: #fff;'>
                                        <td> $b_name </td>
                                        <td> $b_truck </td>
                                        <td> $b_date </td>
                                        <td class='color'><a href='./booking-update.php?id=$b_id'><i class='fas fa-pen-to-square'></i></a> <a href='../includes/delete_booking-driver.php?id=$b_id'><i class='fas fa-trash-can'></i></a></td>
                                   </tr> 
                                   ";
                               }
                            ?>
